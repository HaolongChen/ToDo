  ...
  return (
    <div className="w-full shadow-md h-14 justify-between items-center flex flex-row">
      ...
      <div className='flex justify-end items-center space-x-4'>
        ...
        <button className='hover:cursor-pointer notification-button' onClick={() => navigate('/notifications')}>{notifications.length > 0 ? (<BellWithRedDot className="w-6 h-6" />) : (<Bell className="w-6 h-6" />)}</button>
        <Avatar size={32} />
        <div></div>
      </div>
    </div>
