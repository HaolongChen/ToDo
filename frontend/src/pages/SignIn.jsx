            ...
            <div className="mt-9 mx-10">
              <form onSubmit={handleSubmit}>
                <div className=''>
                  ...
                  <input type="text" required placeholder="Username" className="input block w-115 h-16 rounded-[22px] mt-7 text-[20px] validator backdrop-blur-md bg-white/0 text-gray-600" value={ formData.username } onChange={(e) => {
                ...
                <div className={error ? 'mt-6' : 'mt-12'}>
                  ...
                  <input type="password" required placeholder="Password" className="input block w-115 h-16 rounded-[22px] mt-7 text-[20px] validator backdrop-blur-md bg-white/0 text-gray-600" title="Must be more than 6 characters, including number, lowercase letter, uppercase letter"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" minLength={ 6 } value={ formData.password } onChange={(e) => {
                    setFormData({...formData, password: e.target.value});
                  }}></input>
                  <div><p><a href='/signup' className='text-[16px] text-gray-600 hover:underline hover:text-gray-700 hover:cursor-pointer'>Account doesn't exist?</a></p></div>
                </div>
